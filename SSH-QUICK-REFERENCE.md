...
## Connection Info
- **Host**: 192.168.254.73 or 192.168.50.149
- **Port**: 2222
- **User**: stryk
- **Pass**: 7861
...
### One-liner Commands
```bash
ssh stryk@192.168.254.73 -p 2222 'ls -lh'
...
### Kill a Task
```bash
ssh stryk@192.168.254.73 -p 2222 'bash ~/automation/home-control.sh kill-task download'
```
...
```bash
ssh -R 9000:localhost:8080 stryk@192.168.254.73 -p 2222
...
```bash
ssh stryk@192.168.254.73 -p 2222 'bash ~/automation/launch-script.sh system_info_checker.sh' > ~/phone-output.txt
```
...
```bash
scp -P 2222 ~/photo.jpg stryk@192.168.254.73:/home/STRYK/
```

### Download Entire Directory
```bash
scp -r -P 2222 stryk@192.168.254.73:/home/STRYK/scripts/ ~/Downloads/
```
