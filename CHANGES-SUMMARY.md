...
Transformed PhiLaunch from hardcoded values to a fully portable, configuration-driven system. Users can now run a single setup command to configure PhiLaunch for their environment.
