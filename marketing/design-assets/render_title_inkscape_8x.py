#!/usr/bin/env python3
"""
Export title with Inkscape at 8x, then downsample with ImageMagick.
Best quality + correct rendering.
"""
...
def export_title_8x_inkscape(svg_path, final_width=900, final_height=160):
    """
    ...
    output_path = svg_path.parent / f"{svg_path.stem}_inkscape_ultra_smooth.png"
...
def main():
    ...
    print("=" * 70)
    print("INKSCAPE 8X SUPER-SAMPLING + IMAGEMAGICK LANCZOS DOWNSAMPLING")
    print("=" * 70)
    ...
    try:
        output = export_title_8x_inkscape(svg_path, final_width=900, final_height=160)
        print("\n" + "=" * 70)
        print("SUCCESS - Title rendered with Inkscape + ImageMagick")
        print("=" * 70)
